...
public class SupplierDetailModel : BasePageModel
{
    ...
    public SupplierDetailModel(IConfiguration configuration, PermissionService permissionService) : base(configuration)
    {
    ...
    public async Task<IActionResult> OnPostSaveAsync(CancellationToken cancellationToken)
    {
        ...
        if (!IsEdit)
        {
            return RedirectToPage("./SupplierDetail", new { id = savedId, msg = "created" });
        }

        SetFlashMessage("Saved successfully.", "success");
        return RedirectToPage("./SupplierDetail", new { id = savedId, msg = "saved", viewMode = ViewMode, year = Year });
    }
    ...
    public async Task<IActionResult> OnPostSubmitApprovalAsync(CancellationToken cancellationToken)
    {
        ...
        return RedirectToPage("./SupplierDetail", new { id = Id, msg = "submitted" });
    }
