(function () {
    ...
    function initEvents() {
        ...
        $('#btnAdd').off('click').on('click', function () {
            window.location.href = '/Inventory/LinnenNoteDaily/LinnenNoteDailyDetail?mode=add';
        });
    ...
    function openDetail(index) {
        ...
        if (item.actions?.canAccess) {
            ...
            window.location.href = `/Inventory/LinnenNoteDaily/LinnenNoteDailyDetail?id=${id}&mode=${mode}`;
        } else {
