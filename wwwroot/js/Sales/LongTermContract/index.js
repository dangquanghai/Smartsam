(function () {
    ...
    function performSearch(page = 1) {
        ...
        const filter = {
            ...
            // --- THAY ĐỔI: Gửi 2 chuỗi Range về Server ---
    ...
    $(document).on("change", "input[name='selectedContract']", function () {
        ...
        $("#btnGenBill").prop("disabled", !perms.canGenBill);
    ...
    function initializePage() {
        ...
        $('#btnAdd').off('click').on('click', () => window.location.href = '/Sales/LongTermContract/Add');
        $('#btnEdit').off('click').on('click', () => window.location.href = `/Sales/LongTermContract/Detail?id=${selectedContractId}&mode=edit`);
        $('#btnView').off('click').on('click', () => window.location.href = `/Sales/LongTermContract/Detail?id=${selectedContractId}`);
        $('#btnCopy').off('click').on('click', () => window.location.href = `/Sales/LongTermContract/Create?copyFromId=${selectedContractId}`);
